...
/// Widget that displays past (ended) daily races, if any, as reported by the
/// upstream sources.
class PastDailyRacesDisplay extends StatefulWidget {
  const PastDailyRacesDisplay({super.key});

  @override
  State<PastDailyRacesDisplay> createState() => _PastDailyRacesDisplayState();
}

class _PastDailyRacesDisplayState extends State<PastDailyRacesDisplay> {
  bool _loading = true;
  String? _error;
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('Previous daily races', style: theme.textTheme.titleMedium),
              IconButton(onPressed: _load, icon: const Icon(Icons.refresh)),
            ],
          ),
